...
| 2 | [epic-2-containers.md](./epic-2-containers.md) | US-2.1 ~ US-2.3 | 系统监视器 (容器列表/操作/日志) |
| 3 | [epic-3-app-deployment.md](./epic-3-app-deployment.md) | US-3.1 ~ US-3.11 | 应用商城 (浏览/详情/部署/配置/分享/批量部署/卸载/自定义/模板分享) |
...
| 8 | [epic-8-admin.md](./epic-8-admin.md) | US-8.1 ~ US-8.2 | 共享用户管理 (分享总览/资源概览) |
...
| 11 | [epic-11-cloud-provisioning.md](./epic-11-cloud-provisioning.md) | US-11.1 ~ US-11.7 | 云服务商直连 (能力模型: compute/storage/tunnel/dns，支持 Vultr/DO/Hetzner/Lightsail/Linode/Cloudflare) |
...
| **P0** | US-3.1 浏览应用商城 | Phase 1+2 |
| **P0** | US-3.2 应用详情页 | Phase 2 |
| **P0** | US-3.3 部署应用 | Phase 1+2 |
| **P0** | US-3.4 客户端配置 | Phase 2 |
...
| **P1** | US-3.5 分享给朋友 | Phase 2 |
| **P1** | US-3.7 批量部署 | Phase 3 |
...
| **P2** | US-3.6 管理已分享 | Phase 2 |
| **P2** | US-3.8 卸载应用 | Phase 2 |
| **P2** | US-3.9 更新应用配置 | Phase 4 |
| **P2** | US-3.10 自定义应用 | Phase 3 |
| **P2** | US-3.11 模板分享与导入 | Phase 3 |
...
| **P0** | US-11.3 一键购买 VPS 并部署 Passim (App) | Phase 5+ |
| **P1** | US-11.1 绑定云服务商账号 (App) | Phase 5+ |
| **P1** | US-11.2 浏览 VPS 配置和价格 (App) | Phase 5+ |
| **P1** | US-11.4 查看云端 VPS 状态 (App) | Phase 5+ |
| **P2** | US-11.6 Cloudflare Tunnel 接入 (App) | Phase 5+ |
| **P1** | US-11.7 云服务向导 — 新手全引导 (App) | Phase 5+ |
| **P2** | US-11.5 一键开通云存储 S3 (App) | Phase 5+ |
| **P3 - 后续** | US-8.1 共享用户总览 | Phase 5 |
